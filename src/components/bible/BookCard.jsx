      ...
      <Link to={createPageUrl(`BookDetail?book=${encodeURIComponent(book.name)}`)}>
        ...
        `}>
          ...
          <div className="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-1.5 overflow-hidden">
            <motion.div
              className={`h-full rounded-full ${isComplete ? 'bg-gradient-to-r from-amber-400 to-amber-600 dark:from-amber-500 dark:to-amber-400' : 'bg-green-500 dark:bg-green-500'}`}
              initial={{ width: 0 }}
