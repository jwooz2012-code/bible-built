    ...
    return (
      <motion.div
        ...
        <motion.button
          ...
          className="w-full px-5 py-3.5 rounded-full border border-border/40 bg-card/30 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-card/50 hover:border-border/60 transition-all">
