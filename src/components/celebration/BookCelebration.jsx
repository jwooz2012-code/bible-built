    ...
    >
      ...
      >
        <div className="flex items-center gap-4 px-5 py-4">
          <div className="w-11 h-11 flex-shrink-0 rounded-full bg-muted flex items-center justify-center">
            <BookOpen className="w-5 h-5 text-foreground" strokeWidth={1.75} />
          </div>
