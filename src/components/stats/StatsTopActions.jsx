  ...
  return (
    <>
      <button
        ...
        className="flex items-center justify-center gap-2 bg-card border border-border rounded-xl px-4 h-9 hover:bg-accent transition-colors text-xs font-semibold text-foreground w-full"
      >
        Share
