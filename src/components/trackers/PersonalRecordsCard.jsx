...
export default function PersonalRecordsCard({ records, currentStreak, showTitle = true }) {
  const items = [
  ...
  return (
    <div className={`bg-card border border-border rounded-xl ${showTitle ? 'p-5' : 'p-4'}`}>
      {showTitle && <h3 className="text-base font-semibold text-foreground mb-4">Personal Records</h3>}
