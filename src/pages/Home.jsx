        ...
        <>
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-2 mb-6">
              ...
              size="sm"
              onClick={() => setSelectedTestamentFilter('ALL')} className="bg-slate-50 text-slate-800 px-3 text-xs font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-secondary/80 flex-1 h-9">
