    ...
    <div className="min-h-screen bg-background pb-20">
      <div className="max-w-2xl mx-auto px-5 pb-8">
        ...
        <motion.div
          ...
          <div className="flex items-center gap-3 mb-5">
            <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'hsl(var(--primary)/0.07)' }}>
              <Crown className="w-4 h-4" style={{ color: 'hsl(var(--muted-foreground))' }} />
            </div>
          ...
          {lifetimeLoading ?
            ...
            <div>
              <p className="text-[3.25rem] font-bold tracking-tight leading-none mb-4" style={{ color: '#F97316' }}>{lifetimeTotal}</p>
